...
alias gps='git push'
alias gpl='git pull'
alias ghome="git config --get remote.origin.url 2>/dev/null && git config --get remote.origin.url | sed 's/\.git//; s/git@//; s#https://##; s#:#/#g' | xargs firefox || echo 'Error: no git remote URL'"
