...
alias gpl='git pull'
alias gr='git remote'
alias ghome="git config --get remote.origin.url &>/dev/null && git config --get remote.origin.url | sed 's/\.git//; s/git@//; s#https://##; s#:#/#g' | xargs firefox || echo 'Error: no git remote URL'"
